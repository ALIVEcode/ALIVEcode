import DataSample from '../../../Pages/Challenge/ChallengeAI/artificial_intelligence/DataSample';
import DataTypes from './DataTypes';
import RegressionOptimizer from '../../../Pages/Challenge/ChallengeAI/artificial_intelligence/RegressionOptimizer';
