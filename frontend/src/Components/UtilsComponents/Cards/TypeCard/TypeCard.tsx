	...
	return (
		<div
			className={classNames(
				'relative bg-[color:var(--background-color)] border border-[color:var(--bg-shade-four-color)] aspect-square flex flex-col items-center justify-center gap-8 cursor-pointer rounded-md transition-colors duration-100',
		...
		>
			...
			{props.tooltip && (
				<div className="absolute top-2 right-2">
					...
					>
						<Info.Box useDefaultStyle text={props.tooltip} />
					</Info.Icon>
				</div>
			)}
		</div>
