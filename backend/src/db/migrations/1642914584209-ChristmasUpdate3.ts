...
export class ChristmasUpdate31642914584209 implements MigrationInterface {
    name = 'ChristmasUpdate31642914584209'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "user_entity" SET "image" = ''`);
        await queryRunner.query(`ALTER TABLE "user_entity" ALTER COLUMN "image" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_entity" ALTER COLUMN "image" SET DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "commentaires_forum" ADD CONSTRAINT "FK_35f0cad0e3055836d3dbfe7e22b" FOREIGN KEY ("creatorId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "commentaires_forum" ADD CONSTRAINT "FK_54c5dd26b87c4bf548f2b2cd617" FOREIGN KEY ("postId") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "subject" ADD CONSTRAINT "FK_f81beb44b6ad930bea914860601" FOREIGN KEY ("categoryId") REFERENCES "categories_subject"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "post" ADD CONSTRAINT "FK_9e91e6a24261b66f53971d3f96b" FOREIGN KEY ("creatorId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "result" ADD CONSTRAINT "FK_601be29c4bf75f59d0261f769ba" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "result" ADD CONSTRAINT "FK_ee18239cf6832f54ad345bb87e1" FOREIGN KEY ("quizId") REFERENCES "quiz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quiz" ADD CONSTRAINT "FK_52c158a608620611799fd63a927" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quiz" ADD CONSTRAINT "FK_3507d97bf5eae279599048e6482" FOREIGN KEY ("rewardId") REFERENCES "reward"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quiz" ADD CONSTRAINT "FK_f71164a9a1804f8ba5351bcf437" FOREIGN KEY ("categoryId") REFERENCES "categories_quiz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_e04040c4ea7133eeddefff6417d" FOREIGN KEY ("creatorId") REFERENCES "user_entity"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_c72d82fa0e8699a141ed6cc41b3" FOREIGN KEY ("authorId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "course_history_entity" ADD CONSTRAINT "FK_f86dbfe489c22dd3bae9fce239c" FOREIGN KEY ("courseId") REFERENCES "course_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "course_history_entity" ADD CONSTRAINT "FK_2ee1881c1cf70535ba844d6330a" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "io_t_project_entity_iot_objects_io_t_object_entity" ADD CONSTRAINT "FK_9a06a7f3384daf840cb54ed3112" FOREIGN KEY ("ioTObjectEntityId") REFERENCES "io_t_object_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "io_t_project_entity_iot_objects_io_t_object_entity" DROP CONSTRAINT "FK_9a06a7f3384daf840cb54ed3112"`);
        await queryRunner.query(`ALTER TABLE "course_history_entity" DROP CONSTRAINT "FK_2ee1881c1cf70535ba844d6330a"`);
