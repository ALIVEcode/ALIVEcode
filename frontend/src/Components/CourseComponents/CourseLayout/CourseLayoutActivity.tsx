 ...
 */
const CourseLayoutActivity = forwardRef(
	(
		{ courseElement }: CourseLayoutActivityProps,
		openedActivityRef: LegacyRef<HTMLDivElement>,
	) => {
			...
			<>
				...
				<Modal
					...
					setOpen={(state: boolean) =>
						!state && setTab({ openedActivity: null })
					}
					centered
					hideTitle
					hideFooter
